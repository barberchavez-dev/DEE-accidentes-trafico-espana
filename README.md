...
Código R desarrollado como material suplementario del trabajo final de la asignatura Datos Espaciales y Espaciotemporales (DEE), Grado en Inteligencia y Analítica de Negocios (BIA), Universitat de València.
